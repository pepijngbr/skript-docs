<template>
  <main>
    <h1>Text</h1>
    <p>
      Skript allows you to write pieces of text (aka strings). This is done by putting the text
      inside double quotes, for example: "this is text".
    </p>
    <p>
      If an effect, expression, condition, trigger or function accepts something of type text or
      string, you can use this format to create a new string.
    </p>

    <h2>Colors</h2>
    <p>Minecraft has 16 pre-set color codes to be used in text.</p>
    <ul>
      <li>Color name tags, for example red</li>
      <li>Minecraft color codes, like §c (or &c)</li>
    </ul>
